...
public interface RelationshipRepository extends JpaRepository<Relationship, Integer> { 
	...
	@Query("SELECT r FROM Relationship r where r.state='PENDING' and r.id_user2=:id_user2")
	...
	@Query("SELECT r FROM Relationship r where r.state='FRIEND' and (r.id_user2 =:id_user2 or id_user1=:id_user2)")
